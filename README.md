...
19. Перевірка досткпності слота вимкнення карти.
...
32. Автоматичне "пришвидшене навчання екіпажу":
    Перевірить чи прокачана у вас "Польова модернізація" та включе або виключе "пришвидшене навчання екіпажу",
    також буде враховано набраний на танку досвід щоб не набрати зайвого.
33. ХП свого танка на чільному місці. (Смужка ХП свого танка під прицілом)
34. Вимкнення сирени захоплення бази.
35. Автоматичний збір кланових нагород.
36. Вимкнення віджетів елітності.
```
