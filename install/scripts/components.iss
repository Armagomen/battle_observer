...
procedure ChangeDispersionCircleJsonValues();
var
  Handle: Integer;
begin
...
procedure ChangeEfficiencyJsonValues();
var
  Handle: Integer;
begin
  ...
  begin
    ...
    JSON_SetBool(Handle,'/battles', WizardIsComponentSelected('avg_efficiency_in_hangar/battles'));
    JSON_Close(Handle);
  end;
end;
...
begin
  ...
  if Handle <> 0 then
  begin
    JSON_SetBool(Handle,'/CustomizationForCredits', WizardIsComponentSelected('service_channel_filter/CustomizationForCredits'));
    JSON_SetBool(Handle,'/CustomizationForGold', WizardIsComponentSelected('service_channel_filter/CustomizationForGold'));
    JSON_SetBool(Handle,'/DismantlingForCredits', WizardIsComponentSelected('service_channel_filter/DismantlingForCredits'));
    JSON_SetBool(Handle,'/DismantlingForCrystal', WizardIsComponentSelected('service_channel_filter/DismantlingForCrystal'));
    JSON_SetBool(Handle,'/DismantlingForGold', WizardIsComponentSelected('service_channel_filter/DismantlingForGold'));
    JSON_SetBool(Handle,'/GameGreeting', WizardIsComponentSelected('service_channel_filter/GameGreeting'));
    JSON_SetBool(Handle,'/Information', WizardIsComponentSelected('service_channel_filter/Information'));
    JSON_SetBool(Handle,'/MultipleSelling', WizardIsComponentSelected('service_channel_filter/MultipleSelling'));
    JSON_SetBool(Handle,'/PowerLevel', WizardIsComponentSelected('service_channel_filter/PowerLevel'));
    JSON_SetBool(Handle,'/PurchaseForCredits', WizardIsComponentSelected('service_channel_filter/PurchaseForCredits'));
    JSON_SetBool(Handle,'/PurchaseForCrystal', WizardIsComponentSelected('service_channel_filter/PurchaseForCrystal'));
    JSON_SetBool(Handle,'/PurchaseForGold', WizardIsComponentSelected('service_channel_filter/PurchaseForGold'));
    JSON_SetBool(Handle,'/Remove', WizardIsComponentSelected('service_channel_filter/Remove'));
    JSON_SetBool(Handle,'/Repair', WizardIsComponentSelected('service_channel_filter/Repair'));
    JSON_SetBool(Handle,'/Restore', WizardIsComponentSelected('service_channel_filter/Restore'));
    JSON_SetBool(Handle,'/Selling', WizardIsComponentSelected('service_channel_filter/Selling'));
    JSON_SetBool(Handle,'/autoMaintenance', WizardIsComponentSelected('service_channel_filter/autoMaintenance'));
    JSON_SetBool(Handle,'/customizationChanged', WizardIsComponentSelected('service_channel_filter/customizationChanged'));
    JSON_Close(Handle);
  end;
end;
