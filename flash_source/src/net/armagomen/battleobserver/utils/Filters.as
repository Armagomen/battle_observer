package net.armagomen.battleobserver.utils
{
	...
	public class Filters
	{
		...
		public static const sixthSense:TextFormat = new TextFormat("$TitleFont", 30, 0xFFFFFF, true);
		...
		public static const normalBold:TextFormat = new TextFormat("$TitleFont", 16, 0xFFFFFF, true);
