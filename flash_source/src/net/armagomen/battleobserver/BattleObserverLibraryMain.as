package net.armagomen.battleobserver
{
	...
	public class BattleObserverLibraryMain extends AbstractView
	{
		...
		{
			super();
			BaseBattlePage.prototype.as_BattleObserverCreate = function(aliases:Array, region:String):void
			{
			...
			BaseBattlePage.prototype.as_BattleObserverCreateStatistic = function(iconsEnabled:Boolean, statsData:Object, cutWidth:Number, fullWidth:Number, typeColors:Object, iconMultiplier:Number):void
			{
