...
_Aliases = namedtuple("ALIASES", (
    ...
    "DISPERSION_TIMER", "PANELS", "MINIMAP", "USER_BACKGROUND", "WG_COMP", "DATE_TIME", "DISTANCE"))
ALIASES = _Aliases(
...
class CONFIG_INTERFACE:
    ...
    BLOCK_IDS = (
        ...
        SAVE_SHOOT.NAME, MINIMAP.NAME, ANOTHER.SHADOW_SETTINGS, SIXTH_SENSE.NAME, DISTANCE.NAME, COLORS.NAME,
        SERVICE_CHANNEL.NAME
    )
    HANDLER_VALUES = {
        SNIPER.NAME: {
...
SORTED_ALIASES = (
    ...
    ALIASES.PANELS, ALIASES.MINIMAP, ALIASES.DATE_TIME, ALIASES.DISTANCE, ALIASES.USER_BACKGROUND
)
