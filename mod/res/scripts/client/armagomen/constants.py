...
__Main = namedtuple("MAIN", (
    ...
    "DEBUG", "CREW_TRAINING", "DIRECTIVES", "HIDE_HINT", "FIELD_MAIL", "CREW_RETURN", "STUN_SOUND"))
MAIN = __Main(
    ...
    "do_not_buy_directives_for_currency_automatically", "hide_hint_panel", "hide_field_mail", "auto_return_crew",
    "disable_stun_sound")
