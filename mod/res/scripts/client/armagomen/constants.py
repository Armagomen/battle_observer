...
POSTMORTEM = namedtuple("POSTMORTEM", ("DURATION", "PARAMS", "CAM_MATRIX", "MODES"))(
    "transitionDuration", "postmortemParams", "camMatrix", {CTRL_MODE_NAME.POSTMORTEM,
...
LOAD_LIST = (
    ...
    VEHICLE_TYPES_COLORS.NAME, SNIPER.NAME, COLORS.NAME, ARMOR_CALC.NAME, TEAM_BASES.NAME, FLIGHT_TIME.NAME,
...
class CONFIG_INTERFACE:
    ...
    BLOCK_IDS = (
        ...
        VEHICLE_TYPES_COLORS.NAME, PANELS.PANELS_NAME, SNIPER.NAME, ARCADE.NAME, STRATEGIC.NAME, FLIGHT_TIME.NAME,
        MINIMAP.NAME, SIXTH_SENSE.NAME, DISTANCE.NAME, OWN_HEALTH.NAME, COLORS.NAME,
