...
__Main = namedtuple("MAIN", (
    ...
    "USE_KEY_PAIRS", "IGNORE_COMMANDERS", "DISABLE_SCORE_SOUND", "DEBUG", "DIRECTIVES", "HIDE_HINT",
    "FIELD_MAIL", "STUN_SOUND", "MUTE_BASES_SOUND", "EXCLUDED_MAP_SLOTS_NOTIFICATION",
...
CLOCK = namedtuple("CLOCK", (
    "NAME", "IN_BATTLE", "IN_LOBBY", "FORMAT", "UPDATE_INTERVAL", "DEFAULT_FORMAT"))(
    "clock", "battle", "hangar", "format", 1.0, "%d %b %Y - %H:%M:%S")
...
LOAD_LIST = (
    ...
    STRATEGIC.NAME, PANELS.NAME, MINIMAP.NAME, EFFECTS.NAME, DAMAGE_LOG.WG_LOGS_FIX, DAMAGE_LOG.TOP_LOG, DAMAGE_LOG.EXTENDED_LOG,
...
class CONFIG_INTERFACE:
    ...
    BLOCK_IDS = (
        ...
        PANELS.NAME, SNIPER.NAME, ARCADE.NAME, STRATEGIC.NAME, FLIGHT_TIME.NAME, MINIMAP.NAME, SIXTH_SENSE.NAME, DISTANCE.NAME,
...
ALIAS_TO_CONFIG_NAME_BATTLE = {
    ...
    BATTLE_ALIASES.PANELS: PANELS.NAME,
