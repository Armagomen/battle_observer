...
def new_VehicleArenaInfoVO(base, *args, **kwargs):
    if kwargs:
        ...
        if user_settings.main[MAIN.SHOW_ANONYMOUS] and ANOTHER.ACCOUNT_DBID in kwargs:
        ...
        if user_settings.main[MAIN.HIDE_BATTLE_PRESTIGE_WIDGET] and ANOTHER.PRESTIGE_LEVEL in kwargs:
