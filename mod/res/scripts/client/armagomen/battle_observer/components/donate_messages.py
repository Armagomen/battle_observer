...
class Donate(object):
    ...
    def __init__(self):
        ...
        self.important_date = {
            "17/08": "З днем народження ARMAGOMEN !!!" if support_language else "Happy birthday ARMAGOMEN !!!", }
    ...
    def pushHappy(self):
        ...
        importantly = self.important_date.get("{:02d}/{:02d}".format(date.day, date.month))
        if importantly:
            message = PATTERN.format(msg=importantly, **self.message_format)
