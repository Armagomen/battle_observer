...
EfficiencyAVGData = namedtuple("EfficiencyAVGData", (
    "damage", "assist", "stun", "blocked", "marksOnGunValue", "marksOnGunIcon"))
...
class CurrentVehicleCachedData(object):
    ...
    def __init__(self):
        self.__EfficiencyAVGData = EfficiencyAVGData(0, 0, 0, 0, 0, "")
    ...
    def onVehicleChanged(self):
        if g_currentVehicle.isPresent():
            self.setAvgData(g_currentVehicle.intCD)

    def setAvgData(self, intCD):
        ...
        marksOnGunIcon = "<img src='img://gui/{}' width='20' height='20' vspace='-10'>".format(icon)
        self.__EfficiencyAVGData = EfficiencyAVGData(
            ...
            round(marksOnGun.getDamageRating(), 2), marksOnGunIcon)
