# coding=utf-8
from armagomen.bo_constants import MOD_VERSION
...
translate = {
    ...
    "main": {
        ...
        "hide_server_in_hangar": "Отключить отображение сервера в ангаре.",
        "hide_server_in_hangar_tooltip": "Параметр сработает после перезагрузки ангара либо перезапуска игры."
                                         " <b>Смена сервера через меню настроек станет НЕДОСТУПНА.</b>"
                                         " Для этого необходимо будет перезапустить игру.",
    ...
    "armor_calculator": {
        ...
        "template_tooltip": "HTML - ДА<br>Макросы<br>%(countedArmor)s | s:d:f | type data - приведённая броня."
    ...
    "log_total": {
        ...
        "settings_core*inCenter": "Отображать лог в центре экрана",
        "settings_core*x": "Позиция основного лога по Горизонтали",
        "settings_core*y": "Позиция основного лога по Вертикали",
        "settings_core*align": "Выравнивание:",
        "settings_core*align_tooltip": "Выравнивание:<br>left - влево<br>center - по центру<br>right - вправо",
        "mainLogScale": "Масштабирование лога."
    },
    "log_damage_extended": {
        "header": "РАСШИРЕННЫЙ лог эффективности игрока.",
        "settings_core*x": "Позиция детального лога по Горизонтали.",
        "settings_core*x_tooltip": "Относительно левого списка игроков.",
        "settings_core*y": "Позиция детального лога по Вертикали.",
        "settings_core*y_tooltip": "Относительно левого списка игроков.",
        "settings_core*align": "Выравнивание:",
        "settings_core*align_tooltip": "Выравнивание:<br>left - влево<br>center - по центру<br>right - вправо",
    ...
    "log_input_extended": {
        ...
        "settings_core*x": "Позиция детального лога по Горизонтали",
        "settings_core*x_tooltip": "Относительно дамаг панели.",
        "settings_core*y": "Позиция детального лога по Вертикали",
        "settings_core*y_tooltip": "Относительно дамаг панели.",
        "settings_core*align": "Выравнивание:",
        "settings_core*align_tooltip": "Выравнивание:<br>left - влево<br>center - по центру<br>right - вправо",
        "reverse": "Развернуть лог",
        "reverse_tooltip": "Добавлять новую строку на верх лога.",
    ...
    "main_gun": {
        ...
        "settings_core*x": "Позиция по горизонтали (от центра экрана)",
        "settings_core*y": "Позиция по вертикали (от верхнего края)",
        "settings_core*align": "Выравнивание:",
        "settings_core*align_tooltip": "Выравнивание:<br>left - влево<br>center - по центру<br>right - вправо"
    },
    "team_bases_panel": {
