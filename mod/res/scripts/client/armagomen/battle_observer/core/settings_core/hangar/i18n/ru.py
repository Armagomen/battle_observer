...
translate = {
    ...
    "zoom": {
        ...
        "disable_cam_after_shoot_tooltip": "Автоматически переключает камеру в аркадный режим после выстрела"
                                           " если калибр орудия больше 40мм.",
        "disable_cam_after_shoot_latency": "Задержка автоматического выключения камеры.",
