...
MESSAGES = {
    ...
    "ru": (
        "Привет, друзья! Если вам нравится наш контент, пожалуйста, рассмотрите возможность поддержать нас. Ваши донаты помогают нам создавать ещё больше интересного материала!",
        "Приветствуем, команда! Наш проект растёт благодаря вам. Если вы хотите поддержать нас, перейдите по ссылке в описании. Каждый донат важен!",
        "Друзья, спасибо вам за то, что остаётесь с нами! Если вы хотите помочь развитию нашего проекта, нажмите на ссылку. Ваша поддержка ценна для нас!"
    ),
    "pl": (
