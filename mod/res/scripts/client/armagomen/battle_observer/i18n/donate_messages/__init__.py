...
MESSAGES = {
    "uk": ("Привіт, друзі!\n"
           "Після стрибків напруги, спричинених атакою на Харків три тижні тому, мій процесор і материнська плата частково вийшли з ладу.\n"
           "Щоб продовжувати роботу над модами, потрібно замінити ці деталі.\n"
           "Я відкрив збір коштів на новий процесор та материнську плату. Ціль — 8000 грн.\n"
           "Будь-яка підтримка — фінансова, інформаційна чи навіть просто поширення — буде для мене дуже цінною.\n"
           "Це повністю добровільно, і я щиро вдячний кожному, хто долучиться."),
    # "uk": (
