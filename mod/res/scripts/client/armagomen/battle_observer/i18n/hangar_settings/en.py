...
localization = {
    ...
    "colors": {
        ...
        "armor_calculator*green": "Effective armor: penetration chance 100%",
        "armor_calculator*orange": "Effective armor: penetration chance 50%",
        "armor_calculator*red": "Effective armor: penetration chance 0%",
        "armor_calculator*yellow": "Effective armor: penetration chance 100% (colorblind mode)",
        "armor_calculator*pink": "Effective armor: penetration chance 50% (colorblind mode)",
        "armor_calculator*purple": "Effective armor: penetration chance 0% (colorblind mode)",
        "armor_calculator*normal": "Effective armor: ricochet or non-damaging hit",
    ...
    "service_channel_filter": {
        ...
        "CustomizationForCredits": "Customization for Credits.",
        "CustomizationForGold": "Customization for Gold.",
        "DismantlingForCredits": "Dismantling for Credits.",
        "DismantlingForCrystal": "Dismantling for Bonds.",
        "DismantlingForGold": "Dismantling for Gold.",
        "GameGreeting": "Game greeting.",
        "Information": "Informational messages.",
        "MultipleSelling": "Multiple Selling",
        "PowerLevel": "Research modules and equipment",
        "PurchaseForCredits": "PURCHASES FOR CREDITS.",
        "PurchaseForCrystal": "PURCHASES FOR BONDS.",
        "PurchaseForGold": "PURCHASES FOR GOLD.",
        "Remove": "Remove",
        "Repair": "Repair",
        "Restore": "Restore",
        "Selling": "Selling",
        "autoMaintenance": "Auto-Maintenance.",
        "customizationChanged": "Customization Change"
    },
    "service": {
