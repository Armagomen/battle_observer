...
localization = {
    ...
    "zoom": {
        ...
        "steps_enabled": "Замінити стандартні кратності зуму",
        "steps_range": "Кроки кратності зуму",
        "steps_range_tooltip": "Кратності зуму слід вказувати через кому та пробіл або лише через кому. Підтримується будь-яка кількість значень.",
    },
    "arcade_camera": {
    ...
    "strategic_camera": {
        ...
        "min": "Максимальне наближення (за замовчуванням — 40)",
    ...
    "sixth_sense": {
        ...
        "lampShowTime_tooltip": "<b>Як довго ціль лишається видимою?</b><br>Після виявлення танк залишається видимим навіть без прямої "
                                "видимості. Стандарт — ~10 сек, може змінюватись від 8 до 18 залежно від екіпажу, обладнання та настанов.",
