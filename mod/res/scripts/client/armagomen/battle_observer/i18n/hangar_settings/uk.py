...
localization = {
    ...
    "armor_calculator": {
        ...
        "show_counted_armor": "Показувати ефективну броню",
    ...
    "sixth_sense": {
        ...
        "default_icon_tooltip": "Буде використано вбудоване в мод зображення замість користувацького",
        ...
        "lampShowTime_tooltip": "<b>Як довго ціль лишається видимою?</b><br>Після виявлення танк залишається видимим навіть без прямої "
                                "видимості. Стандарт — ~10 секунд, може змінюватись від 8 до 18 залежно від екіпажу, обладнання та настанов.",
