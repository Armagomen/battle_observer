...
class DefaultSettings(object):
    ...
    def __init__(self):
        ...
        self.statistics = {
            ...
            STATISTICS.PANELS_LEFT_CUT: "<font color='%(colorWTR)s'>%(nickname).8s</font>",
            STATISTICS.PANELS_RIGHT_CUT: "<font color='%(colorWTR)s'>%(nickname).8s</font>",
            STATISTICS.PANELS_CUT_WIDTH: 60,
            STATISTICS.PANELS_FULL_WIDTH: 130,
            STATISTICS.COLORS: {
                "very_good": "#02C9B3",
                "bad": "#FE7903",
                "normal": "#F8F400",
