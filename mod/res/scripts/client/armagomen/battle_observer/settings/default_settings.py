...
class DefaultSettings(object):
    ...
    def __init__(self):
        ...
        self.statistics = {
            ...
            STATISTICS.LOADING_LEFT: "<font color='%(colorWTR)s'>[%(WTR)d] %(nickname).9s</font>%(clanTag)s",
            STATISTICS.LOADING_RIGHT: "%(clanTag)s<font color='%(colorWTR)s'>%(nickname).9s [%(WTR)d]</font>",
            STATISTICS.TAB_LEFT: "<font color='%(colorWTR)s'>[%(WTR)d] %(nickname).15s</font>%(clanTag)s",
            STATISTICS.TAB_RIGHT: "%(clanTag)s<font color='%(colorWTR)s'>%(nickname).15s [%(WTR)d]</font>",
            STATISTICS.PANELS_LEFT: "<font color='%(colorWTR)s'>[%(WTR)d] %(nickname).12s</font>%(clanTag)s",
            STATISTICS.PANELS_RIGHT: "%(clanTag)s<font color='%(colorWTR)s'>%(nickname).12s [%(WTR)d]</font>",
            STATISTICS.PANELS_LEFT_CUT: "<font color='%(colorWTR)s'>%(nickname).9s</font>",
            STATISTICS.PANELS_RIGHT_CUT: "<font color='%(colorWTR)s'>%(nickname).9s</font>",
