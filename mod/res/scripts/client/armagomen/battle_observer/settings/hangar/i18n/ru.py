...
localization = {
    ...
    "main": {
        ...
        "autoClearCache_tooltip": "Очистка временных файлов игры в папке AppData/Roaming/Wargaming.net/WorldOfTanks."
                                  "\nПапки модификацый и настройки которые сохраняются там же, останутся.",
        ...
        "hideChatInRandom_tooltip": "Полностью отключает чат в случайных боях.\nУбирает форму чата и все "
                                    "что с ней связано.",
        "anonymousEnableShow": "Отмечать как team-killer (голубым) игроков с анонимайзером",
        ...
        "anonymousNameChange": "Изменить имена игроков с анонимайзером. на (Anonymous)",
        "useKeyPairs": "Использовать парные Alt, Ctrl, Shift",
        "useKeyPairs_tooltip": "После включения правая и левая клавиша будут восприниматся как одна не зависимо от "
                               "того какую вы выбрали в настройках модулая. Не относится к миникарте.",
    ...
    "statistics": {
        ...
        "statistics_enabled_tooltip": "Статистика будет отображатся на: экране загрузки, в ушах, окне по табу.\n"
    ...
    "minimap": {
        "header": "Мини-Карта.",
        "zoom": "Включить увеличение миникарты в центр.",
