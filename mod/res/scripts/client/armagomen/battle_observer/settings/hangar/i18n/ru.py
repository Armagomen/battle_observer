...
localization = {
    ...
    "sixth_sense": {
        ...
        "use_default_icon": "Использовать встроенное изображение.",
        "use_default_icon_tooltip": "Изображение, встроенное в мод, будет использоваться, пользовательские установки и "
                                    "настройки пользователя будут проигнорированы",
