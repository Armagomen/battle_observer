...
localization = {
    ...
    "main": {
        ...
        "hideChatInRandom_tooltip": "Полностью отключает чат в случайных боях.\nУбирает форму чата и все "
                                    "что с ней связано.",
        "anonymousEnableShow": "Отмечать как team-killer (голубым) игроков с аннонимайзером",
        ...
        "anonymousNameChange": "Изменить имена игроков с аннонимайзером. на (Anonymous)",
    ...
    "zoom": {
        ...
        "dynamic_zoom*zoomXMeters_tooltip": "Автоматический выбор, это расстояние до цели в метрах деленное на "
                                            ...
                                            "тем больше кратность зума в соотношении (дистанция до цели/дистанция для "
