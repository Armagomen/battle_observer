...
timeFormat_tooltip = ("Формат - Значение<br>"
                      "%a - Сокращенное название дня недели<br>"
                      "%A - Полное название дня недели<br>"
                      "%b - Сокращенное название месяца<br>"
                      "%B - Полное название месяца<br>"
                      "%c - Дата и время<br>"
                      "%d - День месяца [01,31]<br>"
                      "%H - Час (24-часовой формат) [00,23]<br>"
                      "%I - Час (12-часовой формат) [01,12]<br>"
                      "%j - День года [001,366]<br>"
                      "%m - Номер месяца [01,12]<br>"
                      "%M - Число минут [00,59]<br>"
                      "%p - До полудня или после (при 12-часовом формате)<br>"
                      "%S - Число секунд [00,61]<br>"
                      "%U - Номер недели в году (нулевая неделя начинается с воскресенья) [00,53]<br>"
                      "%w - Номер дня недели [0(Sunday),6]<br>"
                      "%W - Номер недели в году (нулевая неделя начинается с понедельника) [00,53]<br>"
                      "%x - Дата<br>"
                      "%X - Время<br>"
                      "%y - Год без века [00,99]<br>"
                      "%Y - Год с веком<br>"
                      "%Z - Временная зона<br>"
                      "%% - Знак '%'")
translate = {
    ...
    "updateDialog": {
        ...
        "buttonCancel": "Отмена",
        "messageNEW":
            "<font size='15'><font size='20' color='#FFFF00'><b>Выберите вариант загрузки.</b></font><br>"
            "<p align='left'><font color='#00FF00'><b>Автоматически</b></font> - загрузит и распакует архив "
            "обновления в папку. {0}<br><font color='#FFFF00'><b>Вручную</b></font> - откроет в браузере ссылку на"
            " этот-же архив но извлекать пакет и копировать *.wotmod файл/ы прийдется в ручном режиме.</p></font>"
            "<br><font size='20' color='#FFFF00'><b>Список изменений</b></font><br>",
        "titleNEW": "<br><font size='20'>Доступно обновление <font color='#FFFF00'>v{0}</font></font>"
    },
    "sixth_sense": {
    ...
    "crewDialog": {
        ...
        "submit": "Применить",
        "cancel": "Отменить",
        "ignore": "Игнорировать на этом танке",
