...
translate = {
    ...
    "updateDialog": {
        ...
        "buttonCancel": "Отмена",
        "messageNEW": "<b>Выберите вариант загрузки.</b>\n"
                      "<b>Автоматически</b> - загрузит и распакует архив обновления в папку. {0}\n"
        ...
        "titleNEW": "Battle Observer - Доступно обновление v{0}"
    },
    "sixth_sense": {
