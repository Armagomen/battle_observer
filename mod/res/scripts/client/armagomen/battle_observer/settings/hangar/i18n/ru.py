...
localization = {
    ...
    "dispersion_circle": {
        ...
        "circle_replaceOriginalCircle": "Заменить оригинальный круг сведения уменьшенным.",
        "circle_scale": "Множитель размера круга, 30-100% (0.3-1.0)",
        "circle_scale_tooltip": "Данный параметр влияет на то каким будет итоговый круг сведения, если значение 0.3 "
                                "(30%) круг будет минимально возможным, 1.0 (100%) максимальным. "
