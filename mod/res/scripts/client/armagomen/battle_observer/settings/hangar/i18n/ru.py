...
translate = {
    ...
    "main": {
        ...
        "unlock_crew_experience": "Снимать/Ставить галочку ускоренного обучения экипажа автоматически.",
        "unlock_crew_experience_tooltip": "Если пост-прогрессия доступна для танка и не прокачана, галочка на экипаж "
                                          "будет снята автоматически, как только уровень прогрессии станет "
                                          "максимальным вам предложит включить её назад."
    },
    "dispersion_circle": {
