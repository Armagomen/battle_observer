...
localization = {
    ...
    "dispersion_circle": {
        "header": "Налаштування кола зведення, серверного прицілу, таймеру зведення",
        "circle_enabled": "Використовувати поліпшене коло зведення",
        "circle_extraServerLap": "Використовувати додаткове коло в якості серверного прицілу",
        ...
        "timer_enabled": "Таймер зведення",
        "timer_position_x": "Таймер зведення: Позиція по горизонталі",
        "timer_position_y": "Таймер зведення: Позиція по вертикалі",
        "timer_color": "Таймер зведення: Колір: Не зведено",
        "timer_done_color": "Таймер зведення: Колір: Повністю зведено",
        "timer_align": "Таймер зведення: Вирівнювання тексту"
    },
    "tank_carousel": {
    ...
    "hp_bars": {
        ...
        "style": "Стиль панелі",
        "outline*enabled": "Контур у стилі <b>normal</b>",
        "outline*color": "Контур: колір",
        "markers*enabled": "Карусель маркерів техніки",
        "markers*x": "Карусель маркерів: відстань по горизонталі, від центру",
        "markers*x_tooltip": "Зеркально переміщає значки від центру на задану відстань у пікселях",
        "markers*y": "Карусель маркерів: позиція по вертикалі, від верху",
        "markers*y_tooltip": "Позиція маркерів по вертикалі від верху екрана.",
        "markers*showMarkers_hotkey": "Карусель маркерів: увімкнення/вимкнення маркерів",
        "markers*markersClassColor": "Карусель маркерів: фарбувати значки по кольору класу техніки"
    },
    "armor_calculator": {
