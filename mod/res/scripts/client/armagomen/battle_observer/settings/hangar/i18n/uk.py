...
localization = {
    ...
    "sixth_sense": {
        ...
        "lampShowTime_tooltip": "<b>Як довго виявлений танк лишається видимим?</b><br>Якщо один танк помітив інший "
                                "(їхні лінії огляду перетнулись), то ціль буде залишатись видимою навіть після того, як пряма видимість "
                                "зникне. Стандартний час видимості — приблизно 10 секунд. Цей час може змінюватись: скоротитися до 8 "
                                "секунд або збільшитися до 16–18 секунд, залежно від обладнання, навичок екіпажу та активних настанов.",
