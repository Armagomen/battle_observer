...
localization = {
    ...
    "main": {
        ...
        "directives_only_from_storage": "Заощаджувати бони та срібло на настановах",
        ...
        "show_friends": "Позначити друзів, гравців клану та себе у списках команд",
