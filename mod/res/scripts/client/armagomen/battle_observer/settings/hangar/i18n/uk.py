...
localization = {
    ...
    "main": {
        ...
        "auto_crew_training_tooltip": "Якщо 'Польова модернізація' доступна для танка та вона не повністю прокачана, то"
                                      " галочка на екіпажі буде знята автоматично. Після її повної прокачки вам буде "
                                      "запропоновано увімкнути 'Пришвидшене навчання екіпажу' або залишити все як є.",
    ...
    "clock": {
        ...
        "battle*format_tooltip": "\n".join(timeFormat_tooltip),
