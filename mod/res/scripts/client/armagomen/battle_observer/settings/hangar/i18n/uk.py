...
localization = {
    ...
    "avg_efficiency_in_hangar": {
        ...
        "x": "Позиція тексту по горизонталі",
        "y": "Позиция тексту по вертикалі",
        "avg_damage": "Відображати середню нанесену шкоду",
        "avg_assist": "Відображати середню шкоду завдану за вашою допомогою",
        "avg_blocked": "Відображати середню заблоковану бронею шкоду",
        "avg_stun": "Відображати середню шкоду цілям екіпажі яких ви оглушили (САУ)",
        "gun_marks": "Відображати відсоток відмітної позначки",
    }
}
