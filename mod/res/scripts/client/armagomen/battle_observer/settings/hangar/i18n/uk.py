...
localization = {
    ...
    "sixth_sense": {
        ...
        "use_default_icon": "Використовувати вбудоване зображення.",
        "use_default_icon_tooltip": "Буде використовуватись вбудоване в мод зображення, налаштування тексту та позицій "
                                    "з налаштувань користувача будуть ігноруватись.",
