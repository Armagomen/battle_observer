...
localization = {
    ...
    "main": {
        ...
        "useKeyPairs_tooltip": "Після увімкнення ліва та права клавіша будуть працювати як одна, незалежно від "
        ...
        "ignore_commanders_voice_tooltip": "Після увімкнення буде примусово використовуватися стандартна озвучка"
                                           ...
                                           "на стандартну або зі встановленого мода на озвучку.",
        ...
        "premium_time_tooltip": "Увімкнення або вимкнення відбувається не моментально! Потрібно зачекати до 1 "
                                "хвилини або змінити вкладку гаражу",
        "auto_crew_training": "Автоматичне перемикання галочки \"Пришвидшене навчання екіпажу\"",
        "auto_crew_training_tooltip": "Якщо \"Польова модернізація\" доступна для танка та вона не повністю прокачана, "
        ...
        "auto_return_crew_tooltip": "Якщо на вибраному танку відсутній екіпаж, але він в наявності та не в бою "
    ...
    "statistics": {
        ...
        "statistics_change_vehicle_name_color": "Змінити колір назви танку у вухах на колір згідно зі статистикою гравця",
    ...
    "dispersion_circle": {
        ...
        "circle_extraServerLap_tooltip": "Увімкнення даної функції створить додатковий круг зведення серверного прицілу "
                                         "до основного.",
        "circle_replaceOriginalCircle": "Замінити оригінальний круг зведення зменшеним",
        "circle_scale": "Множник розміру круга 30-100% (0.3-1.0)",
        "circle_scale_tooltip": "Даний параметр впливає на те, яким буде круг зведення у підсумку.\n"
                                "Якщо його значення становить 0.3 (30%), то круг буде мінімально можливим, "
    ...
    "clock": {
        "header": "Налаштування годинника в ангарі та бою",
    ...
    "log_global": {
        ...
        "logsAltmode_hotkey": "Перемикання логів у альтернативний режим",
        ...
        "wg_log_pos_fix_tooltip": "Міняє місцями логи отриманого й нанесеного пошкодження.\nОтриманий знизу, "
                                  "а нанесений зверху."
    },
    "log_total": {
    ...
    "main_gun": {
        "header": "Налаштування основного калібра",
    ...
    "save_shoot": {
        "header": "Налаштування блокування пострілів по союзникам та знищеним",
        "block_on_destroyed": "Заблокувати постріл по знищеним",
        "msg": "Повідомлення про блокування пострілу",
        "msg_tooltip": "Дане повідомлення відображається лише у випадку блокування пострілу по союзнику та "
                       "видно лише гравцю."
    },
    "minimap": {
    ...
    "distance_to_enemy": {
        "header": "Налаштування дистанції до найближчого виявленого ворога",
        "x": "Позиція тексту по горизонталі",
        "x_tooltip": "Положення від центру екрана",
        "y": "Позиція тексту по вертикалі",
        "y_tooltip": "Положення від центру екрана",
