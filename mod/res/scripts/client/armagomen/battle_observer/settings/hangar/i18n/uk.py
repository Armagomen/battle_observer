...
localization = {
    ...
    "zoom": {
        ...
        "zoomToGunMarker": "Увімкнути наближення камери до маркеру гармати",
        "zoomToGunMarker_tooltip": "Увімкнено: наближення до маркеру гармати.\nВимкнено: без змін.\n\n"
                                   "Простіше кажучи: куди дуло направлене, туди і наближення, інакше "
                                   "куди направлена камера.\nДаний режим потребує звикання. Приклад використання: "
                                   "наведіть приціл в небо або пагорб таким чином, аби маркер гармати "
                                   "попав на перешкоду (наприклад - будинок на шляху), але при цьому приціл був не на домі. "
