...
localization = {
    ...
    "main": {
        ...
        "autoClearCache_tooltip": "Очистка тимчасових файлів гри в папці AppData/Roaming/Wargaming.net/WorldOfTanks.\n"
                                  "Папки модифікацій і настройки, які зберігаються там же залишаться.",
        "removeShadowInPrebattle": "Прибрати затемнення таймеру на початку бою",
        "hideBadges": "Вимкнути відображення нашивок в бою",
        "hideBadges_tooltip": "У вухах, у вікні по клавіші Tab та на екрані завантаження.",
        "hideClanAbbrev": "Вимкнути відображення клантегу",
        "hideClanAbbrev_tooltip": "У вухах, у вікні по клавіші Tab та на екрані завантаження.",
        "fps_enableFPSLimiter": "Увімкнути обмежувач FPS",
        "fps_enableFPSLimiter_tooltip": RESTART_TOOLTIP,
        "fps_maxFrameRate": "Максимальный FPS (обмежувач)",
        ...
        "auto_crew_training": "Автоматичне увімкнення/вимкнення галочки \"Пришвидшене навчання екіпажу\"",
        "auto_crew_training_tooltip": "Якщо \"Польова модернізація\" доступна для танка і вона не повністю прокачана, то галочка "
                                      ...
                                      "вам буде запропоновано увімкнути \"Пришвидшене навчання екіпажу\" або ні.",
    ...
    "dispersion_circle": {
        ...
        "circle_scale_tooltip": "Даний параметр впливає на те, яким буде круг сведения у підсумку. Якщо його значення становить 1%, "
                                "то круг буде мінімально можливим, а при 100% - максимально, тобто без змін. "
                                "Не рекомендується встановлювати значення нижче 65%.",
