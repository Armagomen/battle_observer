...
localization = {
    ...
    "main": {
        ...
        "hide_prestige_battle_widget": "Приховати віджет елітних рівнів в бою.",
    ...
    "statistics": {
        ...
        "icons": "Іконки: Перефарбувати у кольори класів техніки",
        "icons_tooltip": "Дана функція перефарбовує будь-які іконки техніки на екрані завантаження, у вухах, "
        ...
        "statistics_colors*good": "Гарно",
        "statistics_colors*very_good": "Дуже гарно",
        "statistics_colors*unique": "Унікально",
        "statistics_panels_full_width": "Ширина поля імені гравця (великі вуха)",
        "statistics_panels_cut_width": "Ширина поля імені гравця (малі вуха)"
    },
    "dispersion_circle": {
