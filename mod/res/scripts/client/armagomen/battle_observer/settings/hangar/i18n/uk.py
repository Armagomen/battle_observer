...
localization = {
    ...
    "main": {
        ...
        "premium_time_tooltip": "Увімкнення або вимкнення відбувається не моментально! Потрібно зачекати до "
    ...
    "log_extended": {
        "header": "Налаштування розширених логів пошкоджень",
