...
class UserSettings(object):
    ...
    def __init__(self):
        ...
        self.statistics = {
            ...
            STATISTICS.FULL_LEFT: "<font color='%(colorWGR)s'>%(WGR)d | %(nickname).12s</font>%(clanTag)s",
            STATISTICS.FULL_RIGHT: "%(clanTag)s<font color='%(colorWGR)s'>%(nickname).12s | %(WGR)d</font>",
            STATISTICS.CUT_LEFT: "<font color='%(colorWGR)s'>%(nickname).9s</font>",
            STATISTICS.CUT_RIGHT: "<font color='%(colorWGR)s'>%(nickname).9s</font>",
